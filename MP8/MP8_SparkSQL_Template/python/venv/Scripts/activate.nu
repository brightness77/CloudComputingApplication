...
def-env activate-virtualenv [] {
    ...
    let virtual_env = 'E:\UIUC\CS498 CCA\MP\MP8\MP8_SparkSQL_Template\python\venv'
    let bin = 'Scripts'
    let path_sep = ';'
...
alias deactivate = source 'E:\UIUC\CS498 CCA\MP\MP8\MP8_SparkSQL_Template\python\venv\Scripts\deactivate.nu'
