...
student = {
    "submitterEmail": "yixiao6@illinois.edu", #<Your coursera account email>
...
viz0CountAirlineColumn = 3 # <index of 'Count of Airline' column (0-indexed)>
viz0LatitudeColumn = 1 # <index of 'Latitude' column (0-indexed)>
viz0LongitudeColumn = 2 # <index of 'Longitude' column (0-indexed)>
