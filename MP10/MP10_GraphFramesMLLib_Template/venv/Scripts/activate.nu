...
def-env activate-virtualenv [] {
    ...
    let virtual_env = 'E:\UIUC\CS498_CCA\MP\MP10\MP10_GraphFramesMLLib_Template\venv'
    let bin = 'Scripts'
    let path_sep = ';'
...
alias deactivate = source 'E:\UIUC\CS498_CCA\MP\MP10\MP10_GraphFramesMLLib_Template\venv\Scripts\deactivate.nu'
