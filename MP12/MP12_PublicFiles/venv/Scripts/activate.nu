...
def-env activate-virtualenv [] {
    ...
    let virtual_env = 'E:\UIUC\CS498_CCA\MP\MP12\MP12_PublicFiles\venv'
    let bin = 'Scripts'
    let path_sep = ';'
...
alias deactivate = source 'E:\UIUC\CS498_CCA\MP\MP12\MP12_PublicFiles\venv\Scripts\deactivate.nu'
